...
def draw_man(x0, y0, Rg, Rh, color1, color2, color3):
	...
	draw_pentagram(x0 -Rg/125*120, y0 + Rg/125*110, 0.32*Rg, 0)	
	draw_pentagram(x0 +Rg/125*120, y0 + Rg/125*110, 0.32*Rg, 180)

	#нос
	brushColor("brown")
	polygon(( (x0 - Rg/125*10, y0 + Rg/125*20), (x0 + Rg/125*10, y0 + Rg/125*20), ( x0, y0 + Rg/125*30), (x0 - Rg/125*10, y0 + Rg/125*20) ))

	#рот
	brushColor("red")
	polygon(( (x0 -Rg/125*50, y0 + Rg/125*50), (x0 + Rg/125*50, y0 + Rg/125*50), ( x0, y0 + Rg/125*90), (x0 - Rg/125*50, y0 + Rg/125*50) ))
